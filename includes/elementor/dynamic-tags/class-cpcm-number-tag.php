<?php
/**
 * Number Dynamic Tag for Elementor
 *
 * @package    CPCM
...
/**
 * CPCM Number Dynamic Tag
 */
class CPCM_Number_Tag extends \Elementor\Core\DynamicTags\Tag {

    /**
     * Get tag name
     */
    public function get_name() {
        return 'cpcm-number-field';
    }
    ...
    public function get_title() {
        return __('رقم من الفيلدات', 'custom-page-content-manager');
    }
    ...
    protected function register_controls() {
        $this->add_control(
            ...
            [
                ...
                'options' => $this->get_number_fields(),
                'default' => '',
            ]
        );
    }
    ...
    /**
     * Get available number fields for current page
     */
    private function get_number_fields() {
